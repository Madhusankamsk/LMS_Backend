...
module.exports.toggleEnrollPapersBySubject = async (subject_id, SubjectInactiveDate) => {
...
module.exports.toggleEnrollPapersByCategory = async (category_id, CategoryInactiveDate) => {
...
module.exports.deleteEnrollPapersBySubject = async (subject_id) => {
    const existingSubject = await subjectService.getSubjectById(subject_id);
    if (!existingSubject) throw new Error('Invalid subject _id');
...
module.exports.deleteEnrollPapersByCategory = async (category_id) => {
...
module.exports.getEnrollPaperById = async (id) => {
    const paper = await repository.findOne(PaperEnrollModel, {
...
module.exports.getEnrollPapers = async (body) => {
    ...
    if (!search) {
        papers = await repository.findByAggregateQuery(PaperEnrollModel, [
            ...prePaginationQuery,
            ...paginationQuery,
            ...combinedQuery,
        ]);
...
module.exports.createEnrollPaper = async (body) => {
    ...
    const existingUser = await userService.getUserById(body.user_id);// need to check if teacher id
    if (!existingUser) {
...
module.exports.toggleEnrollPaper = async (id) => {
