 ...
 * @param grantedArray
 */
module.exports.validateHeader = (grantedArray) => (req, res, next) =>
    // eslint-disable-next-line consistent-return
 ...
 * @param {*} schema
 */
module.exports.validateMultipartFormData =
 ...
 * @returns {function(...[*]=)}
 */
module.exports.validateRouteAccessByRole =
    (allowedRoute) =>
    // eslint-disable-next-line consistent-return
    async (req, res, next) => {
        ...
        if (baseRouteFind && baseRouteFind.is_allowed) {
            const submitBtnActionFind =
                baseRouteFind.submit_button_actions.find(
...
module.exports.validateRouteAccessByRoleMultiple =
    (allowedRoutes) =>
    // eslint-disable-next-line consistent-return
    async (req, res, next) => {
        const superAdminID = process.env.SUPER_ADMIN_ID
